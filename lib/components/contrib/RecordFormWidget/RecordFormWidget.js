...
var RecordFormWidget = function (_React$Component) {
  ...
  _createClass(RecordFormWidget, [{
    ...
    value: function render() {
      ...
      var other = _objectWithoutProperties(_props2, ['collectionActions', 'ownStore', 'ownActions', 'fields', 'location', 'onSaveRedirectTo', 'onCancelRedirectTo', 'displaySubmitButtons', 'exposeStateToRouteQuery', 'history']);
