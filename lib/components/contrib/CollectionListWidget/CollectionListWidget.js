...
var CollectionListWidget = function CollectionListWidget(props) {
  ...
  var other = _objectWithoutProperties(props, ['ownStore', 'linkedRouteQuery', 'hideIfEmpty', 'searchStore', 'searchProperty', 'properties', 'unstackable', 'onClickRedirectTo', 'location']);
