...
var _CardWidget = require('../../widgets/CardWidget');
...
var CollectionListWidget = function CollectionListWidget(props) {
  ...
  var hideIfEmpty = props.hideIfEmpty;
  ...
  var other = _objectWithoutProperties(props, ['ownStore', 'linkedRouteQuery', 'hideIfEmpty', 'searchStore', 'searchProperty', 'properties', 'unstackable', 'onClickRedirectTo', 'location', 'history']);
...
CollectionListWidget.propTypes = {
  ...
  hideIfEmpty: _react.PropTypes.bool,
