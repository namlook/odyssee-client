...
var ConfirmButtonUI = exports.ConfirmButtonUI = function (_React$Component) {
  ...
  _createClass(ConfirmButtonUI, [{
    ...
    value: function render() {
      ...
      var className = this.state.confirmState ? this.props.className + ' ' + this.props.confirmClassName : this.props.className + ' ' + this.props.displayClassName;
...
ConfirmButtonUI.propTypes = {
  ...
  confirmLabel: _react.PropTypes.string.isRequired,
